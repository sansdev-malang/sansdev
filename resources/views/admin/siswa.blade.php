    ...
    <div class="p-6 space-y-6">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">Laki-laki</p>
                        <h3 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-50 mt-1">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">Perempuan</p>
                        <h3 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-50 mt-1">
                ...
                <table class="w-full text-sm border-collapse">
                    <thead>
                        <tr class="border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
                            <th
                                ...
                                No</th>
                            <th
                                class="px-6 py-4 text-left text-xs font-bold text-slate-550 dark:text-slate-400 uppercase tracking-wider w-24">
                                NIS</th>
                            <th
                                class="px-6 py-4 text-left text-xs font-bold text-slate-550 dark:text-slate-400 uppercase tracking-wider w-32">
                                NISN</th>
                            <th
                            ...
                            <th
                                ...
                                Kelas</th>
                            <th
                                class="px-6 py-4 text-left text-xs font-bold text-slate-550 dark:text-slate-400 uppercase tracking-wider w-28">
                                Rombel</th>
                            <th
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-900">
                        ...
                        <tr class="student-row hover:bg-slate-50/40 dark:hover:bg-slate-900/20 transition-colors">
                            ...
                            <td class="student-nis px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">1235
                            </td>
                            <td class="student-nisn px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">
                                1234567891</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="student-name text-slate-900 dark:text-slate-50 font-semibold tracking-tight">Siti
                                        Rahmawati</span>
                                </div>
                            </td>
                            <td class="student-kelas px-6 py-4 text-slate-600 dark:text-slate-400">11</td>
                            <td class="student-rombel px-6 py-4 text-slate-600 dark:text-slate-400 font-medium">XI-IPA
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button
                                        class="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-850 rounded-lg text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-slate-100 transition-colors cursor-pointer"
                                        title="Edit Data">
                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                    </button>
                                    <button
                        ...
                        <tr class="student-row hover:bg-slate-50/40 dark:hover:bg-slate-900/20 transition-colors">
                            ...
                            <td class="student-nis px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">1236
                            </td>
                            <td class="student-nisn px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">
                                1234567892</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="student-name text-slate-900 dark:text-slate-50 font-semibold tracking-tight">Budi
                                        Wijaya</span>
                                </div>
                            </td>
                            <td class="student-kelas px-6 py-4 text-slate-600 dark:text-slate-400">12</td>
                            <td class="student-rombel px-6 py-4 text-slate-600 dark:text-slate-400 font-medium">XII-IPS
                            </td>
                            <td class="px-6 py-4 text-slate-600 dark:text-slate-400">Laki-laki</td>
                            <td class="px-6 py-4">
                                <span
                        ...
                        <tr class="student-row hover:bg-slate-50/40 dark:hover:bg-slate-900/20 transition-colors">
                            ...
                            <td class="student-nis px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">1237
                            </td>
                            <td class="student-nisn px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">
                                1234567893</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="student-name text-slate-900 dark:text-slate-50 font-semibold tracking-tight">Dewi
                                        Lestari</span>
                                </div>
                            </td>
                            <td class="student-kelas px-6 py-4 text-slate-600 dark:text-slate-400">10</td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button
                                        class="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-455 hover:text-slate-950 dark:hover:text-slate-100 transition-colors cursor-pointer"
                                        title="Edit Data">
                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                    </button>
                                    <button
                        ...
                        <tr class="student-row hover:bg-slate-50/40 dark:hover:bg-slate-900/20 transition-colors">
                            ...
                            <td class="student-nis px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">1238
                            </td>
                            <td class="student-nisn px-6 py-4 text-slate-500 dark:text-slate-400 font-mono text-xs">
                                1234567894</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xs font-bold text-slate-700 dark:text-slate-355 shrink-0">
                                        FH
                                    </div>
                                    <span
                                        class="student-name text-slate-900 dark:text-slate-50 font-semibold tracking-tight">Fajar
                                        Hidayat</span>
                                </div>
                            </td>
                            <td class="student-kelas px-6 py-4 text-slate-600 dark:text-slate-400">11</td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button
                                        class="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-855 rounded-lg text-slate-600 dark:text-slate-455 hover:text-slate-950 dark:hover:text-slate-100 transition-colors cursor-pointer"
                                        title="Edit Data">
                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                    </button>
                                    <button
